...
export const getIframeSrc = (mediaData: MediaData): string => {
  ...
  switch (apiType) {
    ...
    case "autoembed":
      ...
      return type === "series"
        ? `${baseUrl}tv/${seriesId}/${season}/${episodeNo}?autoplay=true`
        : `${baseUrl}movie/${movieId}?autoplay=true`
    case "2embed":
      return type === "series"
        ? `https://www.2embed.cc/embed/tv/${seriesId}&s=${season}&e=${episodeNo}`
